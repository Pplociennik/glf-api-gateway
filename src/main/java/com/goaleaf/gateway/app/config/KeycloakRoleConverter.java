...
/**
 * A converter for Keycloak roles.
 *
 * @author Created by: Pplociennik at 21.02.2025 19:13
 */
class KeycloakRoleConverter implements Converter< Jwt, Collection< GrantedAuthority > > {
    ...
    public Collection< GrantedAuthority > convert( Jwt source ) {
        ...
        Collection< GrantedAuthority > resultRoles = ( ( List< String > ) realmAccess.get( "roles" ) )
                .stream()
